...
1. Os laboratórios prometem receitas futuras massivas.
2. Com base nessas projeções, assinam contratos gigantescos de hardware e cloud.
3. Os fabricantes de chips expandem produção e valorização.
4. O mercado financeiro capitaliza essa expectativa.
5. O capital regressa ao ecossistema, financiando mais modelos, mais chips e mais data centers.
