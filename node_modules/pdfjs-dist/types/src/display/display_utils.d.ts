...
export class PagesMapper {
     ...
     */
    static "__#private@#idToPageNumber": Uint32Array | null;
    /**
     * Maps page numbers to their corresponding page IDs.
     * @type {Uint32Array|null}
     */
    static "__#private@#pageNumberToId": Uint32Array | null;
    /**
     * Previous mapping of page IDs to page numbers.
     * @type {Uint32Array|null}
     */
    static "__#private@#prevIdToPageNumber": Uint32Array | null;
    /**
     * The total number of pages.
     * @type {number}
     */
    static "__#private@#pagesNumber": number;
    /**
     * Listeners for page changes.
     * @type {Array<function>}
     */
    static "__#private@#listeners": Array<Function>;
    /**
     * Gets or creates a singleton instance of PagesMapper.
     * @returns {PagesMapper} The singleton instance.
     */
    static get instance(): PagesMapper;
    /**
    ...
    getPrevPageNumber(pageNumber: any): number;
    /**
