 ...
 */
export declare const append: <T extends AnyNode>(this: Cheerio<T>, ...elems: BasicAcceptedElems<AnyNode>[] | [(this: AnyNode, i: number, html: string) => BasicAcceptedElems<AnyNode>]) => Cheerio<T>;
/**
 ...
 */
export declare const prepend: <T extends AnyNode>(this: Cheerio<T>, ...elems: BasicAcceptedElems<AnyNode>[] | [(this: AnyNode, i: number, html: string) => BasicAcceptedElems<AnyNode>]) => Cheerio<T>;
/**
