...
function find(selectorOrHaystack) {
    ...
    if (typeof selectorOrHaystack !== 'string') {
        var haystack = (0, utils_js_1.isCheerio)(selectorOrHaystack)
            ...
            : [selectorOrHaystack];
        var context_1 = this.toArray();
        return this._make(haystack.filter(function (elem) { return context_1.some(function (node) { return (0, static_js_1.contains)(node, elem); }); }));
    }
...
function _findBySelector(selector, limit) {
    ...
    var elems = reSiblingSelector.test(selector)
        ? context
...
exports.siblings = _matcher(function (elem) {
    return (0, domutils_1.getSiblings)(elem).filter(function (el) { return (0, domhandler_1.isTag)(el) && el !== elem; });
 ...
 */
exports.children = _matcher(function (elem) { return (0, domutils_1.getChildren)(elem).filter(domhandler_1.isTag); }, _removeDuplicates);
/**
