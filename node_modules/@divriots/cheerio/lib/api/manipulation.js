...
function _makeDomArray(elem, clone) {
    ...
    if ('length' in elem) {
        ...
        for (var i = 0; i < elem.length; i++) {
            ...
            result.push.apply(result, this._makeDomArray(el, clone));
        }
        return result;
    }
...
function insertAfter(target) {
    ...
    this.remove();
    var clones = [];
    for (var _i = 0, _a = this._makeDomArray(target); _i < _a.length; _i++) {
        var el = _a[_i];
        var clonedSelf = this.clone().toArray();
        var parent_1 = el.parent;
        if (!parent_1) {
            continue;
        }
        var siblings = parent_1.children;
        var index = siblings.indexOf(el);
        // If not found, move on
        /* istanbul ignore next */
        if (index < 0)
        ...
        uniqueSplice(siblings, index + 1, 0, clonedSelf, parent_1);
 ...
 */
function clone() {
    var clone = Array.prototype.map.call(this.get(), function (el) {
