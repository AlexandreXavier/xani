...
const processFile = async (file, stats) => {
    ...
    try {
        ...
        switch (ext) {
            ...
            case '.avif':
                ...
                if ((newImage === null || newImage === void 0 ? void 0 : newImage.data) && newImage.data.length < stats.size) {
...
export async function compressFolder(exclude) {
