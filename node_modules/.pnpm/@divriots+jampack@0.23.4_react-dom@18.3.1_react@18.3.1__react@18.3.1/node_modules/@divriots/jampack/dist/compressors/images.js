...
function createWebpOptions(opt) {
    return {
...
export async function compressImage(data, options) {
    ...
    if (meta.format === 'svg') {
        if (!config.image.svg.optimization)
            return undefined;
        try {
    ...
    if (toFormat === 'unchanged') {
        ...
        switch (toFormat) {
            ...
            case 'png':
                ...
                break;
            case 'webp':
                sharpFile = sharpFile.webp(createWebpOptions(meta.format === 'png'
    ...
    if (((_a = options.resize) === null || _a === void 0 ? void 0 : _a.width) || ((_b = options.resize) === null || _b === void 0 ? void 0 : _b.height)) {
