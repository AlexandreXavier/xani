        ...
        return (0, utils_js_1.domEach)(this, function (el) {
            ...
            if (typeof name === 'object') {
                for (var _i = 0, _a = Object.keys(name); _i < _a.length; _i++) {
                    var key = _a[_i];
                    var val_1 = name[key];
                    setProp(el, key, val_1, _this.options.xmlMode);
                }
            }
            else {
...
function readAllData(el) {
    for (var _i = 0, _a = Object.keys(el.attribs); _i < _a.length; _i++) {
        var domName = _a[_i];
        if (!domName.startsWith(dataAttrPrefix)) {
            continue;
        }
        var jsName = (0, utils_js_1.camelCase)(domName.slice(dataAttrPrefix.length));
...
function readData(el, name) {
    var domName = dataAttrPrefix + (0, utils_js_1.cssCase)(name);
    var data = el.data;
        ...
        case 'select': {
            ...
            if (!querying) {
                ...
                for (var _i = 0, values_1 = values; _i < values_1.length; _i++) {
                    var val_2 = values_1[_i];
                    this.find("option[value=\"".concat(val_2, "\"]")).attr('selected', '');
                }
                return this;
            }
...
function hasClass(className) {
    return this.toArray().some(function (elem) {
        var clazz = (0, domhandler_1.isTag)(elem) && elem.attribs['class'];
        var idx = -1;
    ...
    for (var i = 0; i < numElements; i++) {
        ...
        if (className) {
            ...
            for (var _i = 0, classNames_1 = classNames; _i < classNames_1.length; _i++) {
                var cn = classNames_1[_i];
                var appendClass = "".concat(cn, " ");
