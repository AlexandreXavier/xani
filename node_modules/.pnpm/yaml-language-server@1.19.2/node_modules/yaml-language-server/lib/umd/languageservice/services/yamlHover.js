...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-types", "../utils/arrUtils", "../parser/isKubernetes", "../parser/yaml-documents", "../parser/jsonParser07", "vscode-uri", "path", "@vscode/l10n", "yaml"], factory);
    }
                ...
                if (schema && node && !schema.errors.length) {
                    ...
                    matchingSchemas.every((s) => {
                        if ((s.node === node || (node.type === 'property' && node.valueNode === s.node)) && !s.inverted && s.schema) {
                            ...
                            if (s.schema.enum) {
                                enumIdx = s.schema.enum.indexOf((0, jsonParser07_1.getNodeValue)(node));
