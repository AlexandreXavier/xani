...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-types", "yaml", "../../../languageservice/utils/astUtils", "@vscode/l10n"], factory);
    }
        ...
        validate(document, yamlDoc) {
            ...
            for (const anchor of anchors) {
                if (!usedAnchors.has(anchor)) {
                    ...
                    if (aToken) {
                        ...
                        const warningDiagnostic = vscode_languageserver_types_1.Diagnostic.create(range, l10n.t('unUsedAnchor', aToken.source), vscode_languageserver_types_1.DiagnosticSeverity.Information, 0);
            ...
            unIdentifiedAlias.forEach((node) => {
                ...
                if (nodeRange) {
                    ...
                    const warningDiagnostic = vscode_languageserver_types_1.Diagnostic.create(range, l10n.t('unUsedAlias', node.toString()), vscode_languageserver_types_1.DiagnosticSeverity.Information, 0);
                    warningDiagnostic.tags = [vscode_languageserver_types_1.DiagnosticTag.Unnecessary];
                    result.push(warningDiagnostic);
                }
            });
