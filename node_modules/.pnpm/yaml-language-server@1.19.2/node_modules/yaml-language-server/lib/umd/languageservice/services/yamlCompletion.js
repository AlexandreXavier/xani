...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-types", "yaml", "../utils/arrUtils", "../utils/indentationGuesser", "../utils/textBuffer", "../utils/json", "../utils/objects", "../parser/isKubernetes", "../parser/jsonParser07", "../utils/astUtils", "./modelineUtil", "../utils/schemaUtils", "@vscode/l10n"], factory);
    }
    ...
    class YamlCompletion {
        ...
        addArrayItemValueCompletion(schema, separatorAfter, collector, index) {
            ...
            const documentation = this.getDocumentationWithMarkdownText(l10n.t('create.item.array', schemaTypeTitle, schemaDescription), insertText);
            collector.add({
